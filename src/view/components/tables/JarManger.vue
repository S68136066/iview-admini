<template v-for="(item,index) in showList">
  <div>
    <audio autoplay muted id="audio" src="../audio/tishiJar.wav" />
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { title: "需求负责人", key: "principal", align: "center" },
        { title: "更新环境", key: "upEnv", align: "center" },
        {
          title: "状态",
          key: "status",
          align: "center",
        ...
        { title: "提交时间", key: "subTime", align: "center", width: "150px" },
        {
          title: "完成时间",
          key: "finishTime",
          align: "center",
